...
#procedura za brisanje blagajnika
						#id
CALL brisanje_blagajnika(3);

#procedura za brisanje proizvoda preko naziva
						#   naziv
CALL brisanje_proizvoda('boca plina');

##### IDEJA IDEJA MOŽDA NAPRAVITI OVAKO ODMAH DA ISPIŠE KOLIČINU!
SELECT id_pumpa,p.id AS sifra_artikla, naziv, cijena, kolicina, kolicina_prodanog_artikl(50) FROM prodani_proizvodi pp
